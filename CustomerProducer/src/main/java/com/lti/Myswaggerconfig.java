...
public class Myswaggerconfig {
	...
	private ApiInfo metadata() {
		return new ApiInfoBuilder().title("Assessment for Week 2 - Vineetha Gourishetty")
				.description("API reference guide BANK Application using MICROSERVICES")
				.termsOfServiceUrl("https://Vineetha.Gourishetty").contact("LNT user").version("1.0").build();
	}
}